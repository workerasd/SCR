...
parser.add_argument('--result_root_path', type = str, default="logs/",
...
print(args.name)
stamp = timestamp()
result_path = result_root + f"{args.dataset}/{stamp}_{args.name}_svdw{args.svd_weight}_stdw{args.std_weight}_seed{args.seed}/"
if args.ts_name!='':
